...
export const metadata: Metadata = {
  title: "SecureDID Panelist Portal",
  description: "Vote on enrollment, revocation, and panelist-replacement proposals.",
};
...
const ShieldIcon = () => (
  <svg width="22" height="22" viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="1.6" aria-hidden>
    ...
    <rect x="10.5" y="12.5" width="6.5" height="5" rx="2.5" /><rect x="15" y="14.5" width="6.5" height="5" rx="2.5" />
  </svg>
);

export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning data-app="panelist" className={`${inter.variable} ${mono.variable} ${display.variable}`}>
        ...
        <RainbowKitProvider>
          <nav className="sd-nav">
            <div className="sd-nav__left">
              ...
              <span className="sd-nav-app">Panelist</span>
            </div>
            <div className="sd-nav__right"><ConnectButton /></div>
          </nav>
          <main>{children}</main>
        </RainbowKitProvider>
      </body>
