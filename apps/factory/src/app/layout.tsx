...
export const metadata: Metadata = {
  title: "SecureDID Factory",
  description: "Deploy and manage institutional DID registries on Base Sepolia.",
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning data-app="factory" className={`${inter.variable} ${mono.variable} ${display.variable}`}>
        ...
        <WalletProvider>
          <nav className="sd-nav">
            <div className="sd-nav__left">
              ...
              <span className="sd-nav-app">Factory</span>
              <div className="sd-nav-tabs">
                <Link href="/" className="sd-nav-tab">Registries</Link>
                <Link href="/create" className="sd-nav-tab">Create new</Link>
                <Link href="/explore" className="sd-nav-tab">Explore</Link>
              </div>
            </div>
