    ...
    <div className="sd-page">
      ...
      {!address && !error && (
        <div className="sd-card sd-card--pad" style={{ textAlign: "center", padding: "56px 24px" }}>
          ...
          <p className="sd-empty__sub">Use the button in the top-right to connect MetaMask on Base Sepolia. Only institutions deployed by your wallet will be shown here.</p>
        </div>
      )}
