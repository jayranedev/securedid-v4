...
export const metadata: Metadata = {
  title: "SecureDID College Portal",
  description: "Attend classes and access college services with your DID.",
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning data-app="college" className={`${inter.variable} ${mono.variable} ${display.variable}`}>
        ...
        <RainbowKitProvider>
          <nav className="sd-nav">
            <div className="sd-nav__left">
              ...
              <span className="sd-nav-app">College Portal</span>
            </div>
